...
export function Navbar() {
  ...
  return (
    <nav className="container bg-white rounded-navbar flex justify-between items-center p-5 lg:px-10 md:px-7 px-5 sticky top- z-50">
      <LogoIcon className="md:!w-36 w-28 lg:min-h-10 min-h-full" />
